...
class AgentQuitCopy extends Packet {
	...
	public static format: Map<string, any> = new Map([
		...
		[
			...
			{
				quantity: 1,
				parameters: new Map<string, any>([["viewerCircuitCode", Types.U32]]),
			},
		],
	])

	/**
	 * AgentQuitCopy constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link AgentQuitCopy.format}. Note that
