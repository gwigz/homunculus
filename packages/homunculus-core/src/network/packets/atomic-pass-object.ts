 ...
 */
class AtomicPassObject extends Packet {
	/**
		...
		[
			"taskData",
			{
				...
				parameters: new Map<string, any>([
					["task", Types.UUID],
					["attachmentNeedsSave", Types.Boolean],
				]),
			},
		],
	])
	...
	/**
	 * AtomicPassObject constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link AtomicPassObject.format}. Note that
...
export default AtomicPassObject
