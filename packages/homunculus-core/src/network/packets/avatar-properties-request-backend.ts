...
class AvatarPropertiesRequestBackend extends Packet {
		...
		[
			"agentData",
			{
				...
				parameters: new Map<string, any>([
					...
					["avatar", Types.UUID],
					["godLevel", Types.U8],
					["webProfilesDisabled", Types.Boolean],
				]),
			},
		],
	])
	...
	/**
	 * AvatarPropertiesRequestBackend constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link AvatarPropertiesRequestBackend.format}. Note that
