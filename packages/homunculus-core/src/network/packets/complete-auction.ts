...
class CompleteAuction extends Packet {
	...
	public static override format: Map<string, any> = new Map([
		[
			"parcelData",
			{ parameters: new Map<string, any>([["parcel", Types.UUID]]) },
		],
	])

	/**
	 * CompleteAuction constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link CompleteAuction.format}. Note that
