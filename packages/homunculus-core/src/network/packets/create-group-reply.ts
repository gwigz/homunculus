 ...
 */
class CreateGroupReply extends Packet {
	/**
	...
	/**
	 * CreateGroupReply constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link CreateGroupReply.format}. Note that
...
export default CreateGroupReply
