 ...
 */
class CrossedRegion extends Packet {
	/**
	...
	/**
	 * CrossedRegion constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link CrossedRegion.format}. Note that
