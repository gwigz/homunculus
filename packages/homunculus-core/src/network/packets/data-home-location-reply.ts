 ...
 */
class DataHomeLocationReply extends Packet {
	/**
	...
	/**
	 * DataHomeLocationReply constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link DataHomeLocationReply.format}. Note that
...
export default DataHomeLocationReply
