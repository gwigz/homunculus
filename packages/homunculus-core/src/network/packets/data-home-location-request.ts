...
class DataHomeLocationRequest extends Packet {
	...
	/**
	 * DataHomeLocationRequest constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link DataHomeLocationRequest.format}. Note that
