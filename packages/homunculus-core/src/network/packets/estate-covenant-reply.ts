 ...
 */
class EstateCovenantReply extends Packet {
	/**
	...
	/**
	 * EstateCovenantReply constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link EstateCovenantReply.format}. Note that
...
export default EstateCovenantReply
