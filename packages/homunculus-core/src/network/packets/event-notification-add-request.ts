...
class EventNotificationAddRequest extends Packet {
	...
	/**
	 * EventNotificationAddRequest constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link EventNotificationAddRequest.format}. Note that
