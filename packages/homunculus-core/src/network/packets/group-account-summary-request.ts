...
class GroupAccountSummaryRequest extends Packet {
	...
	/**
	 * GroupAccountSummaryRequest constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link GroupAccountSummaryRequest.format}. Note that
