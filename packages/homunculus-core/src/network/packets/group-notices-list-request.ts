...
class GroupNoticesListRequest extends Packet {
	...
	/**
	 * GroupNoticesListRequest constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link GroupNoticesListRequest.format}. Note that
