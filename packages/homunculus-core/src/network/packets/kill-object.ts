...
class KillObject extends Packet {
	...
	public static override format: Map<string, any> = new Map([
		["objectData", { parameters: new Map<string, any>([["id", Types.U32]]) }],
	])

	/**
	 * KillObject constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link KillObject.format}. Note that
