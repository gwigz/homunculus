...
class LandStatRequest extends Packet {
		...
		[
			"requestData",
			{
				...
				parameters: new Map<string, any>([
					...
					["filter", Types.Variable1],
					["parcelLocal", Types.S32],
				]),
			},
		],
	])
	...
	/**
	 * LandStatRequest constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link LandStatRequest.format}. Note that
