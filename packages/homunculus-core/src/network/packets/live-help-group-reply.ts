 ...
 */
class LiveHelpGroupReply extends Packet {
	/**
	 * Packet ID, this value is only unique per-frequency range, see key get
	 * method of Packet, plus the buffer helper of the network namespace for
	 * generating a lookup codes.
	 */
	public static id = 380
	...
	/**
	 * LiveHelpGroupReply constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link LiveHelpGroupReply.format}. Note that
...
export default LiveHelpGroupReply
