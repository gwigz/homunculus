 ...
 */
class MoveInventoryFolder extends Packet {
	/**
	...
	/**
	 * MoveInventoryFolder constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link MoveInventoryFolder.format}. Note that
...
export default MoveInventoryFolder
