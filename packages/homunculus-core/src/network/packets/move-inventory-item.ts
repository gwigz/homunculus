 ...
 */
class MoveInventoryItem extends Packet {
	/**
	...
	/**
	 * MoveInventoryItem constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link MoveInventoryItem.format}. Note that
