...
class ObjectIncludeInSearch extends Packet {
	...
	/**
	 * ObjectIncludeInSearch constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link ObjectIncludeInSearch.format}. Note that
