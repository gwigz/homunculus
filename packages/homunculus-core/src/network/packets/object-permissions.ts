 ...
 */
class ObjectPermissions extends Packet {
	/**
	...
	public static override format: Map<string, any> = new Map([
		...
		[
			...
			{
				quantity: 1,
				parameters: new Map<string, any>([["override", Types.Boolean]]),
			},
		],
		[
			"objectData",
	...
	/**
	 * ObjectPermissions constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link ObjectPermissions.format}. Note that
