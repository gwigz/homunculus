...
class ParcelPropertiesRequestByID extends Packet {
	...
	/**
	 * ParcelPropertiesRequestByID constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link ParcelPropertiesRequestByID.format}. Note that
