 ...
 * ParcelRename Packet
 */
class ParcelRename extends Packet {
	/**
	...
	/**
	 * ParcelRename constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link ParcelRename.format}. Note that
