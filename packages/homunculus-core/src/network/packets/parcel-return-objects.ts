...
class ParcelReturnObjects extends Packet {
	...
	public static override format: Map<string, any> = new Map([
		...
		["taskIDs", { parameters: new Map<string, any>([["task", Types.UUID]]) }],
		["ownerIDs", { parameters: new Map<string, any>([["owner", Types.UUID]]) }],
	])

	/**
	 * ParcelReturnObjects constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link ParcelReturnObjects.format}. Note that
