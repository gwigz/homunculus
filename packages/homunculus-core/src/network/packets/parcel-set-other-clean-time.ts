...
class ParcelSetOtherCleanTime extends Packet {
	...
	/**
	 * ParcelSetOtherCleanTime constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link ParcelSetOtherCleanTime.format}. Note that
