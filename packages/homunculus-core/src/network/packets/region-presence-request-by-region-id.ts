...
/**
 * RegionPresenceRequestByRegionID Packet
 */
class RegionPresenceRequestByRegionID extends Packet {
	...
	/**
	 * RegionPresenceRequestByRegionID constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link RegionPresenceRequestByRegionID.format}. Note that
