...
class RemoveInventoryObjects extends Packet {
	...
	public static override format: Map<string, any> = new Map([
		...
		["itemData", { parameters: new Map<string, any>([["item", Types.UUID]]) }],
	])

	/**
	 * RemoveInventoryObjects constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link RemoveInventoryObjects.format}. Note that
