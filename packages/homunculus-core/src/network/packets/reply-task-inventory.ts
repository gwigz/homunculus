 ...
 */
class ReplyTaskInventory extends Packet {
	/**
	...
	/**
	 * ReplyTaskInventory constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link ReplyTaskInventory.format}. Note that
...
export default ReplyTaskInventory
