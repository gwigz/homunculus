...
class RequestTaskInventory extends Packet {
	...
	public static override format: Map<string, any> = new Map([
		...
		[
			...
			{
				quantity: 1,
				parameters: new Map<string, any>([["local", Types.U32]]),
			},
		],
	])

	/**
	 * RequestTaskInventory constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link RequestTaskInventory.format}. Note that
