...
class ScriptDataReply extends Packet {
	...
	/**
	 * ScriptDataReply constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link ScriptDataReply.format}. Note that
