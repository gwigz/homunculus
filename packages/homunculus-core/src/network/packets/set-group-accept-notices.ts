...
class SetGroupAcceptNotices extends Packet {
	...
	public static format: Map<string, any> = new Map([
		...
		[
			...
			{
				quantity: 1,
				parameters: new Map<string, any>([["listInProfile", Types.Boolean]]),
			},
		],
	])

	/**
	 * SetGroupAcceptNotices constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link SetGroupAcceptNotices.format}. Note that
