...
class StateSave extends Packet {
	...
	public static format: Map<string, any> = new Map([
		...
		[
			...
			{
				quantity: 1,
				parameters: new Map<string, any>([["filename", Types.Variable1]]),
			},
		],
	])

	/**
	 * StateSave constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link StateSave.format}. Note that
