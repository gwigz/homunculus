 ...
 */
class TeleportFailed extends Packet {
	/**
	...
	/**
	 * TeleportFailed constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link TeleportFailed.format}. Note that
