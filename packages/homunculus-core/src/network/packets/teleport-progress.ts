 ...
 */
class TeleportProgress extends Packet {
	/**
	...
	/**
	 * TeleportProgress constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link TeleportProgress.format}. Note that
...
export default TeleportProgress
