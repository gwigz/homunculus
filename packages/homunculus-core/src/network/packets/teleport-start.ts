...
class TeleportStart extends Packet {
	...
	public static override format: Map<string, any> = new Map([
		[
			...
			{
				quantity: 1,
				parameters: new Map<string, any>([["teleportFlags", Types.U32]]),
			},
		],
	])

	/**
	 * TeleportStart constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link TeleportStart.format}. Note that
