...
class TransferRequest extends Packet {
	...
	/**
	 * TransferRequest constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link TransferRequest.format}. Note that
