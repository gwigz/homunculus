 ...
 */
class UseCircuitCode extends Packet {
	/**
	...
	/**
	 * UseCircuitCode constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link UseCircuitCode.format}. Note that
