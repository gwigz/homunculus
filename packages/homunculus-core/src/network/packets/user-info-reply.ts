...
class UserInfoReply extends Packet {
		...
		[
			"userData",
			{
				...
				parameters: new Map<string, any>([
					["imViaEmail", Types.Boolean],
					["directoryVisibility", Types.Variable1],
					["email", Types.Variable2],
				]),
			},
		],
	])
	...
	/**
	 * UserInfoReply constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link UserInfoReply.format}. Note that
