...
export const id = 368
export const name = "ActivateGroup"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ActivateGroupData>) {
...
export function decode(buffer: Buffer): ActivateGroupData {
