...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<AgentPauseData>) {
...
export function decode(buffer: Buffer): AgentPauseData {
