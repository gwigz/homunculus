...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<AgentResumeData>) {
...
export function decode(buffer: Buffer): AgentResumeData {
