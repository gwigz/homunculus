...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<AgentSitData>) {
...
export function decode(buffer: Buffer): AgentSitData {
