...
export const id = 103
export const name = "BuyObjectInventory"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<BuyObjectInventoryData>) {
	...
	offset = Primitives.UUID.encode(data.data.folderId, buffer, offset)

	return buffer
}

export function decode(buffer: Buffer): BuyObjectInventoryData {
