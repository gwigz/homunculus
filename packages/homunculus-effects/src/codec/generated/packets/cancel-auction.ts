...
export const id = 232
export const name = "CancelAuction"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<CancelAuctionData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): CancelAuctionData {
	const state = { offset: HEADER_SIZE }

	return {
		parcelData: (() => {
			const items: CancelAuctionData["parcelData"] = []
