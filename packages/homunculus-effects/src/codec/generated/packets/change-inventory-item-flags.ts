...
export const id = 271
export const name = "ChangeInventoryItemFlags"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ChangeInventoryItemFlagsData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): ChangeInventoryItemFlagsData {
	...
	return {
		...
		inventoryData: (() => {
			const items: ChangeInventoryItemFlagsData["inventoryData"] = []
