...
export const id = 225
export const name = "CheckParcelSales"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<CheckParcelSalesData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): CheckParcelSalesData {
	const state = { offset: HEADER_SIZE }

	return {
		regionData: (() => {
			const items: CheckParcelSalesData["regionData"] = []
