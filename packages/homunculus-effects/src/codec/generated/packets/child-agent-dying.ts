...
export const id = 240
export const name = "ChildAgentDying"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ChildAgentDyingData>) {
...
export function decode(buffer: Buffer): ChildAgentDyingData {
