...
export const id = 231
export const name = "CompleteAuction"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<CompleteAuctionData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): CompleteAuctionData {
	const state = { offset: HEADER_SIZE }

	return {
		parcelData: (() => {
			const items: CompleteAuctionData["parcelData"] = []
