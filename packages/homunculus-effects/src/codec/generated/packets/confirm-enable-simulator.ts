...
export const id = 8
export const name = "ConfirmEnableSimulator"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ConfirmEnableSimulatorData>) {
...
export function decode(buffer: Buffer): ConfirmEnableSimulatorData {
