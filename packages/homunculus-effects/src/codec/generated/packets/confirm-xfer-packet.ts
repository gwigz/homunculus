...
export const id = 19
export const name = "ConfirmXferPacket"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ConfirmXferPacketData>) {
...
export function decode(buffer: Buffer): ConfirmXferPacketData {
