...
export const id = 339
export const name = "CreateGroupRequest"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<CreateGroupRequestData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): CreateGroupRequestData {
