...
export const id = 317
export const name = "DeactivateGestures"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<DeactivateGesturesData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): DeactivateGesturesData {
	...
	return {
		...
		data: (() => {
			const items: DeactivateGesturesData["data"] = []
