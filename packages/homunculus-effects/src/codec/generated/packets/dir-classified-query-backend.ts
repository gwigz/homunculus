...
export const id = 40
export const name = "DirClassifiedQueryBackend"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<DirClassifiedQueryBackendData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): DirClassifiedQueryBackendData {
