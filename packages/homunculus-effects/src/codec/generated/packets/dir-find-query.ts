...
export const id = 31
export const name = "DirFindQuery"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<DirFindQueryData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): DirFindQueryData {
