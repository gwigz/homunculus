...
export const id = 49
export const name = "DirLandQueryBackend"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<DirLandQueryBackendData>) {
...
export function decode(buffer: Buffer): DirLandQueryBackendData {
