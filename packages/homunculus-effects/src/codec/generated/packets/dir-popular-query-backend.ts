...
export const id = 52
export const name = "DirPopularQueryBackend"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<DirPopularQueryBackendData>) {
...
export function decode(buffer: Buffer): DirPopularQueryBackendData {
