...
export const id = 51
export const name = "DirPopularQuery"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<DirPopularQueryData>) {
...
export function decode(buffer: Buffer): DirPopularQueryData {
