...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<EjectUserData>) {
...
export function decode(buffer: Buffer): EjectUserData {
