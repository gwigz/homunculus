...
export interface EstateOwnerMessageData {
	agentData: {
		agentId?: Types.UUID
...
export const id = 260
export const name = "EstateOwnerMessage"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<EstateOwnerMessageData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): EstateOwnerMessageData {
	...
	return {
		...
		paramList: (() => {
			const items: EstateOwnerMessageData["paramList"] = []
