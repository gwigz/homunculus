...
export const id = 179
export const name = "EventInfoRequest"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<EventInfoRequestData>) {
...
export function decode(buffer: Buffer): EventInfoRequestData {
