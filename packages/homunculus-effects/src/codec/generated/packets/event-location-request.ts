...
export const id = 307
export const name = "EventLocationRequest"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<EventLocationRequestData>) {
...
export function decode(buffer: Buffer): EventLocationRequestData {
