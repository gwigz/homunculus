...
export const id = 181
export const name = "EventNotificationAddRequest"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<EventNotificationAddRequestData>) {
...
export function decode(buffer: Buffer): EventNotificationAddRequestData {
