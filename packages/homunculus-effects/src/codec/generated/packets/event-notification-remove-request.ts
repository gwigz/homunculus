...
export const id = 182
export const name = "EventNotificationRemoveRequest"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<EventNotificationRemoveRequestData>) {
...
export function decode(buffer: Buffer): EventNotificationRemoveRequestData {
