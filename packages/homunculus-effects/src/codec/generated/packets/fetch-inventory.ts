...
export const id = 279
export const name = "FetchInventory"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<FetchInventoryData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): FetchInventoryData {
	...
	return {
		...
		inventoryData: (() => {
			const items: FetchInventoryData["inventoryData"] = []
