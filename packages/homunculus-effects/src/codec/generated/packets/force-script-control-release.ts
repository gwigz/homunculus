...
export const id = 192
export const name = "ForceScriptControlRelease"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ForceScriptControlReleaseData>) {
...
export function decode(buffer: Buffer): ForceScriptControlReleaseData {
