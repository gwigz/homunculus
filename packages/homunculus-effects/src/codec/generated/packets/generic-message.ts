...
export const id = 261
export const name = "GenericMessage"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<GenericMessageData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): GenericMessageData {
	...
	return {
		...
		paramList: (() => {
			const items: GenericMessageData["paramList"] = []
