...
export const id = 259
export const name = "GodlikeMessage"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<GodlikeMessageData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): GodlikeMessageData {
	...
	return {
		...
		paramList: (() => {
			const items: GodlikeMessageData["paramList"] = []
