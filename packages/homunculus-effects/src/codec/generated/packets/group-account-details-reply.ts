...
export const id = 356
export const name = "GroupAccountDetailsReply"
...
const HISTORY_DATA_BASE_SIZE = Primitives.S32.size() // amount
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<GroupAccountDetailsReplyData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): GroupAccountDetailsReplyData {
	...
	return {
		...
		historyData: (() => {
			const items: GroupAccountDetailsReplyData["historyData"] = []
