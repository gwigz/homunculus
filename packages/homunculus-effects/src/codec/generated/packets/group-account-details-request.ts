...
export const id = 355
export const name = "GroupAccountDetailsRequest"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<GroupAccountDetailsRequestData>) {
...
export function decode(buffer: Buffer): GroupAccountDetailsRequestData {
