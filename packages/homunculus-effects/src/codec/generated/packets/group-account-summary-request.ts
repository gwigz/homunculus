...
export const id = 353
export const name = "GroupAccountSummaryRequest"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<GroupAccountSummaryRequestData>) {
...
export function decode(buffer: Buffer): GroupAccountSummaryRequestData {
