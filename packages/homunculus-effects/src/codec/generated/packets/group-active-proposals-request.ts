...
export const id = 359
export const name = "GroupActiveProposalsRequest"
...
const BASE_SIZE =
	// Header
	HEADER_SIZE + AGENT_DATA_BASE_SIZE + GROUP_DATA_BASE_SIZE + TRANSACTION_DATA_BASE_SIZE

export function encode(sequence: number, reliable: boolean, data: DeepRequired<GroupActiveProposalsRequestData>) {
...
export function decode(buffer: Buffer): GroupActiveProposalsRequestData {
