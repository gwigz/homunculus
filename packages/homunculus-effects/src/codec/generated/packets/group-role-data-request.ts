...
export const id = 371
export const name = "GroupRoleDataRequest"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<GroupRoleDataRequestData>) {
...
export function decode(buffer: Buffer): GroupRoleDataRequestData {
