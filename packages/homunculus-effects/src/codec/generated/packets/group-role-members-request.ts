...
export const id = 373
export const name = "GroupRoleMembersRequest"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<GroupRoleMembersRequestData>) {
...
export function decode(buffer: Buffer): GroupRoleMembersRequestData {
