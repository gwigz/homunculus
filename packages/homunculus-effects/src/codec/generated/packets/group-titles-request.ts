...
export const id = 375
export const name = "GroupTitlesRequest"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<GroupTitlesRequestData>) {
...
export function decode(buffer: Buffer): GroupTitlesRequestData {
