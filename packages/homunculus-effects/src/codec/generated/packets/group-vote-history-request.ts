...
export const id = 361
export const name = "GroupVoteHistoryRequest"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<GroupVoteHistoryRequestData>) {
...
export function decode(buffer: Buffer): GroupVoteHistoryRequestData {
