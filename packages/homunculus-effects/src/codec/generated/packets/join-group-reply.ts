...
export const id = 344
export const name = "JoinGroupReply"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<JoinGroupReplyData>) {
	...
	offset = Primitives.Boolean.encode(data.groupData.success, buffer, offset)

	return buffer
}

export function decode(buffer: Buffer): JoinGroupReplyData {
