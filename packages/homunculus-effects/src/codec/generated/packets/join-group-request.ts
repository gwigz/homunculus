...
export const id = 343
export const name = "JoinGroupRequest"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<JoinGroupRequestData>) {
...
export function decode(buffer: Buffer): JoinGroupRequestData {
