...
export const id = 348
export const name = "LeaveGroupReply"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<LeaveGroupReplyData>) {
...
export function decode(buffer: Buffer): LeaveGroupReplyData {
