...
export const id = 347
export const name = "LeaveGroupRequest"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<LeaveGroupRequestData>) {
...
export function decode(buffer: Buffer): LeaveGroupRequestData {
