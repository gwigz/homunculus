...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<LogoutReplyData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): LogoutReplyData {
	...
	return {
		...
		inventoryData: (() => {
			const items: LogoutReplyData["inventoryData"] = []
