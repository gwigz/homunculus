...
export const id = 252
export const name = "LogoutRequest"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<LogoutRequestData>) {
...
export function decode(buffer: Buffer): LogoutRequestData {
