...
export const id = 408
export const name = "MapNameRequest"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<MapNameRequestData>) {
	...
	size += Primitives.Variable1.size(data.nameData.name)
	...
	// NameData
	offset = Primitives.Variable1.encode(data.nameData.name, buffer, offset)

	return buffer
}

export function decode(buffer: Buffer): MapNameRequestData {
