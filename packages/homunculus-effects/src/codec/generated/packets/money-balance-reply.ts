...
export const id = 314
export const name = "MoneyBalanceReply"
...
const BASE_SIZE =
	// Header
	HEADER_SIZE + MONEY_DATA_BASE_SIZE + TRANSACTION_INFO_BASE_SIZE

export function encode(sequence: number, reliable: boolean, data: DeepRequired<MoneyBalanceReplyData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): MoneyBalanceReplyData {
