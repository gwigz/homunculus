...
export const id = 268
export const name = "MoveInventoryItem"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<MoveInventoryItemData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): MoveInventoryItemData {
	...
	return {
		...
		inventoryData: (() => {
			const items: MoveInventoryItemData["inventoryData"] = []
