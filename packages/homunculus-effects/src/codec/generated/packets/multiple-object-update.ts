...
export const id = 2
export const name = "MultipleObjectUpdate"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<MultipleObjectUpdateData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): MultipleObjectUpdateData {
	...
	return {
		...
		objectData: (() => {
			const items: MultipleObjectUpdateData["objectData"] = []
