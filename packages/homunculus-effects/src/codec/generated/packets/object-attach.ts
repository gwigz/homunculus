...
export const id = 112
export const name = "ObjectAttach"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ObjectAttachData>) {
	let size = BASE_SIZE
	...
	offset = Primitives.U8.encode(data.agentData.attachmentPoint, buffer, offset)
...
export function decode(buffer: Buffer): ObjectAttachData {
	...
	return {
		...
		objectData: (() => {
			const items: ObjectAttachData["objectData"] = []
