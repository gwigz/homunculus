...
const AGENT_DATA_BASE_SIZE =
	...
	Primitives.UUID.size() // categoryId
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ObjectBuyData>) {
	let size = BASE_SIZE
	...
	offset = Primitives.UUID.encode(data.agentData.categoryId, buffer, offset)
...
export function decode(buffer: Buffer): ObjectBuyData {
	...
	return {
		agentData: {
			...
			categoryId: Primitives.UUID.decode(buffer, state),
		},
		objectData: (() => {
			const items: ObjectBuyData["objectData"] = []
