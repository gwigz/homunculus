...
export const id = 109
export const name = "ObjectCategory"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ObjectCategoryData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): ObjectCategoryData {
	...
	return {
		...
		objectData: (() => {
			const items: ObjectCategoryData["objectData"] = []
