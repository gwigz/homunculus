...
export const id = 95
export const name = "ObjectClickAction"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ObjectClickActionData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): ObjectClickActionData {
	...
	return {
		...
		objectData: (() => {
			const items: ObjectClickActionData["objectData"] = []
