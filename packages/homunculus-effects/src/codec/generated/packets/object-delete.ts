...
export const id = 89
export const name = "ObjectDelete"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ObjectDeleteData>) {
	let size = BASE_SIZE
	...
	offset = Primitives.Boolean.encode(data.agentData.force, buffer, offset)
...
export function decode(buffer: Buffer): ObjectDeleteData {
	...
	return {
		agentData: {
			...
			force: Primitives.Boolean.decode(buffer, state),
		},
		objectData: (() => {
			const items: ObjectDeleteData["objectData"] = []
