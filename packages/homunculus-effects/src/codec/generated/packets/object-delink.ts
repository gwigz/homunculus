...
export const id = 116
export const name = "ObjectDelink"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ObjectDelinkData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): ObjectDelinkData {
	...
	return {
		...
		objectData: (() => {
			const items: ObjectDelinkData["objectData"] = []
