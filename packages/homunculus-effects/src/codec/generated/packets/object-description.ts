...
export const id = 108
export const name = "ObjectDescription"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ObjectDescriptionData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): ObjectDescriptionData {
	...
	return {
		...
		objectData: (() => {
			const items: ObjectDescriptionData["objectData"] = []
