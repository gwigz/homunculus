...
export const id = 111
export const name = "ObjectDeselect"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ObjectDeselectData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): ObjectDeselectData {
	...
	return {
		...
		objectData: (() => {
			const items: ObjectDeselectData["objectData"] = []
