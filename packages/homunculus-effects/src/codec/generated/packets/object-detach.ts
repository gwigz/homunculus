...
export const id = 113
export const name = "ObjectDetach"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ObjectDetachData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): ObjectDetachData {
	...
	return {
		...
		objectData: (() => {
			const items: ObjectDetachData["objectData"] = []
