...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ObjectDropData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): ObjectDropData {
	...
	return {
		...
		objectData: (() => {
			const items: ObjectDropData["objectData"] = []
