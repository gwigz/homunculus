...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ObjectGroupData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): ObjectGroupData {
	...
	return {
		...
		objectData: (() => {
			const items: ObjectGroupData["objectData"] = []
