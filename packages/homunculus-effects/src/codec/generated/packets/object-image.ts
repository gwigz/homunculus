...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ObjectImageData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): ObjectImageData {
	...
	return {
		...
		objectData: (() => {
			const items: ObjectImageData["objectData"] = []
