...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ObjectLinkData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): ObjectLinkData {
	...
	return {
		...
		objectData: (() => {
			const items: ObjectLinkData["objectData"] = []
