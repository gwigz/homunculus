...
export const id = 97
export const name = "ObjectMaterial"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ObjectMaterialData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): ObjectMaterialData {
	...
	return {
		...
		objectData: (() => {
			const items: ObjectMaterialData["objectData"] = []
