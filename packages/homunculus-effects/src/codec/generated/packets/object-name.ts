...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ObjectNameData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): ObjectNameData {
	...
	return {
		...
		objectData: (() => {
			const items: ObjectNameData["objectData"] = []
