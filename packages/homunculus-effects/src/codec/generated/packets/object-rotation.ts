...
export const id = 93
export const name = "ObjectRotation"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ObjectRotationData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): ObjectRotationData {
	...
	return {
		...
		objectData: (() => {
			const items: ObjectRotationData["objectData"] = []
