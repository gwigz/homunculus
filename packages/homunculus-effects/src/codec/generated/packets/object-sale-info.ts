...
export const id = 106
export const name = "ObjectSaleInfo"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ObjectSaleInfoData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): ObjectSaleInfoData {
	...
	return {
		...
		objectData: (() => {
			const items: ObjectSaleInfoData["objectData"] = []
