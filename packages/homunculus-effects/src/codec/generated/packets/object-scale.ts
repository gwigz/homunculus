...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ObjectScaleData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): ObjectScaleData {
	...
	return {
		...
		objectData: (() => {
			const items: ObjectScaleData["objectData"] = []
