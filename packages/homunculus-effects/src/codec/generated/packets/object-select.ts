...
export const id = 110
export const name = "ObjectSelect"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ObjectSelectData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): ObjectSelectData {
	...
	return {
		...
		objectData: (() => {
			const items: ObjectSelectData["objectData"] = []
