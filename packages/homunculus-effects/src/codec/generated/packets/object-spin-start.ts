...
export const id = 120
export const name = "ObjectSpinStart"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ObjectSpinStartData>) {
...
export function decode(buffer: Buffer): ObjectSpinStartData {
