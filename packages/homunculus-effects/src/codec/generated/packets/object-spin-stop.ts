...
export const id = 122
export const name = "ObjectSpinStop"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ObjectSpinStopData>) {
...
export function decode(buffer: Buffer): ObjectSpinStopData {
