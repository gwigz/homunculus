...
export const id = 14
export const name = "ObjectUpdateCached"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ObjectUpdateCachedData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): ObjectUpdateCachedData {
	...
	return {
		...
		objectData: (() => {
			const items: ObjectUpdateCachedData["objectData"] = []
