...
export const id = 13
export const name = "ObjectUpdateCompressed"
...
const OBJECT_DATA_BASE_SIZE = Primitives.U32.size() // updateFlags
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ObjectUpdateCompressedData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): ObjectUpdateCompressedData {
	...
	return {
		...
		objectData: (() => {
			const items: ObjectUpdateCompressedData["objectData"] = []
