...
export const id = 206
export const name = "ParcelBuyPass"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ParcelBuyPassData>) {
...
export function decode(buffer: Buffer): ParcelBuyPassData {
