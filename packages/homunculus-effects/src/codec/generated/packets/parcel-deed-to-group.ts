...
export const id = 207
export const name = "ParcelDeedToGroup"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ParcelDeedToGroupData>) {
...
export function decode(buffer: Buffer): ParcelDeedToGroupData {
