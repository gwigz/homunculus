...
export const id = 214
export const name = "ParcelGodForceOwner"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ParcelGodForceOwnerData>) {
...
export function decode(buffer: Buffer): ParcelGodForceOwnerData {
