...
export const id = 227
export const name = "ParcelGodMarkAsContent"
...
const PARCEL_DATA_BASE_SIZE = Primitives.S32.size() // localId
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ParcelGodMarkAsContentData>) {
...
export function decode(buffer: Buffer): ParcelGodMarkAsContentData {
