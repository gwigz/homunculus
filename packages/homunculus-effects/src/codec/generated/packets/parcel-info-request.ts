...
export const id = 54
export const name = "ParcelInfoRequest"
...
const DATA_BASE_SIZE = Primitives.UUID.size() // parcelId
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ParcelInfoRequestData>) {
...
export function decode(buffer: Buffer): ParcelInfoRequestData {
