...
export const id = 56
export const name = "ParcelObjectOwnersRequest"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ParcelObjectOwnersRequestData>) {
...
export function decode(buffer: Buffer): ParcelObjectOwnersRequestData {
