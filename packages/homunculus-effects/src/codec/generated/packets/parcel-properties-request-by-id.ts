...
export const id = 197
export const name = "ParcelPropertiesRequestByID"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ParcelPropertiesRequestByIDData>) {
...
export function decode(buffer: Buffer): ParcelPropertiesRequestByIDData {
