...
export const id = 15
export const name = "RegionPresenceRequestByHandle"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<RegionPresenceRequestByHandleData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): RegionPresenceRequestByHandleData {
	const state = { offset: HEADER_SIZE }

	return {
		regionData: (() => {
			const items: RegionPresenceRequestByHandleData["regionData"] = []
