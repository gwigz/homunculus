...
export const id = 287
export const name = "RemoveTaskInventory"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<RemoveTaskInventoryData>) {
...
export function decode(buffer: Buffer): RemoveTaskInventoryData {
