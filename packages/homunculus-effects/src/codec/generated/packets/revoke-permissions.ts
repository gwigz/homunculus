...
export const id = 193
export const name = "RevokePermissions"
...
const DATA_BASE_SIZE =
	...
	Primitives.U32.size() // objectPermissions
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<RevokePermissionsData>) {
	...
	offset = Primitives.U32.encode(data.data.objectPermissions, buffer, offset)

	return buffer
}

export function decode(buffer: Buffer): RevokePermissionsData {
	...
	return {
		...
		data: {
			...
			objectPermissions: Primitives.U32.decode(buffer, state),
		},
	}
}
