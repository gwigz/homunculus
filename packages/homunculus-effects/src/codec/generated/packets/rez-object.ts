...
const BASE_SIZE =
	// Header
	HEADER_SIZE + AGENT_DATA_BASE_SIZE + REZ_DATA_BASE_SIZE + INVENTORY_DATA_BASE_SIZE

export function encode(sequence: number, reliable: boolean, data: DeepRequired<RezObjectData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): RezObjectData {
