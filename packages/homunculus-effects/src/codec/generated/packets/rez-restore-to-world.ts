...
export const id = 425
export const name = "RezRestoreToWorld"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<RezRestoreToWorldData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): RezRestoreToWorldData {
