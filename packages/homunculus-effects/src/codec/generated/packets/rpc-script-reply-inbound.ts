...
export const id = 417
export const name = "RpcScriptReplyInbound"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<RpcScriptReplyInboundData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): RpcScriptReplyInboundData {
