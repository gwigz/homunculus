...
export const id = 88
export const name = "SetAlwaysRun"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<SetAlwaysRunData>) {
...
export function decode(buffer: Buffer): SetAlwaysRunData {
