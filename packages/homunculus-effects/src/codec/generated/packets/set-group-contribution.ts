...
export const id = 369
export const name = "SetGroupContribution"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<SetGroupContributionData>) {
	...
	offset = Primitives.S32.encode(data.data.contribution, buffer, offset)

	return buffer
}

export function decode(buffer: Buffer): SetGroupContributionData {
