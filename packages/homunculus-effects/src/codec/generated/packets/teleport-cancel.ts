...
export const id = 72
export const name = "TeleportCancel"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<TeleportCancelData>) {
...
export function decode(buffer: Buffer): TeleportCancelData {
