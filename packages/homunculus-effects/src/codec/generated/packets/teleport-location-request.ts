...
export const id = 63
export const name = "TeleportLocationRequest"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<TeleportLocationRequestData>) {
...
export function decode(buffer: Buffer): TeleportLocationRequestData {
