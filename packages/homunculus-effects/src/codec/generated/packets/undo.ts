...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<UndoData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): UndoData {
	...
	return {
		...
		objectData: (() => {
			const items: UndoData["objectData"] = []
