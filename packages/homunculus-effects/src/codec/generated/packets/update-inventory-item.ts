...
export const id = 266
export const name = "UpdateInventoryItem"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<UpdateInventoryItemData>) {
	let size = BASE_SIZE
...
export function decode(buffer: Buffer): UpdateInventoryItemData {
	...
	return {
		...
		inventoryData: (() => {
			const items: UpdateInventoryItemData["inventoryData"] = []
