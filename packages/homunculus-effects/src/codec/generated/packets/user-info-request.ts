...
export const id = 399
export const name = "UserInfoRequest"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<UserInfoRequestData>) {
...
export function decode(buffer: Buffer): UserInfoRequestData {
