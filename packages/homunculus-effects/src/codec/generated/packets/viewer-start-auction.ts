...
export const id = 228
export const name = "ViewerStartAuction"
...
export function encode(sequence: number, reliable: boolean, data: DeepRequired<ViewerStartAuctionData>) {
...
export function decode(buffer: Buffer): ViewerStartAuctionData {
