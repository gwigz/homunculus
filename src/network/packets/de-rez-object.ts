 ...
 * DeRezObject Packet
 */
class DeRezObject extends Packet {
	/**
	...
	/**
	 * DeRezObject constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link DeRezObject.format}. Note that
