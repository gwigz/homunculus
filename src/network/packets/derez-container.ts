 ...
 */
class DerezContainer extends Packet {
	/**
	...
	/**
	 * DerezContainer constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link DerezContainer.format}. Note that
