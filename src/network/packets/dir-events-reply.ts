...
class DirEventsReply extends Packet {
	...
	public static format: Collection<string, any> = new Collection([
		...
		[
			"statusData",
			{ parameters: new Collection<string, any>([["status", Types.U32]]) },
		],
	])

	/**
	 * DirEventsReply constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link DirEventsReply.format}. Note that
