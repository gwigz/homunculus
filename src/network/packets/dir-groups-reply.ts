 ...
 */
class DirGroupsReply extends Packet {
	/**
	...
	public static format: Collection<string, any> = new Collection([
		...
		[
			...
			{
				quantity: 1,
				parameters: new Collection<string, any>([["query", Types.UUID]]),
			},
		],
		// tslint:disable-next-line:max-line-length
		[
	...
	/**
	 * DirGroupsReply constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link DirGroupsReply.format}. Note that
	 ...
	 * @param {string} [data.queryReplies.group] GroupID
