...
class GroupActiveProposalsRequest extends Packet {
	...
	/**
	 * GroupActiveProposalsRequest constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link GroupActiveProposalsRequest.format}. Note that
