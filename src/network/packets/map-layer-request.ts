 ...
 */
class MapLayerRequest extends Packet {
	/**
	...
	/**
	 * MapLayerRequest constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link MapLayerRequest.format}. Note that
...
export default MapLayerRequest
