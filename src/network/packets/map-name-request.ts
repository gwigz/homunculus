...
/**
 * MapNameRequest Packet
 */
class MapNameRequest extends Packet {
	/**
	...
	public static format: Collection<string, any> = new Collection([
		...
		[
			...
			{
				quantity: 1,
				parameters: new Collection<string, any>([["name", Types.Variable1]]),
			},
		],
	])

	/**
	 * MapNameRequest constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link MapNameRequest.format}. Note that
