...
class NearestLandingRegionRequest extends Packet {
	...
	/**
	 * NearestLandingRegionRequest constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link NearestLandingRegionRequest.format}. Note that
