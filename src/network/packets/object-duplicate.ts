 ...
 */
class ObjectDuplicate extends Packet {
	/**
	...
	/**
	 * ObjectDuplicate constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link ObjectDuplicate.format}. Note that
	 ...
	 * @param {Vector3} [data.sharedData.offset] Offset
