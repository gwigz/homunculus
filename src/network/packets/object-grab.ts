...
class ObjectGrab extends Packet {
	...
	/**
	 * ObjectGrab constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link ObjectGrab.format}. Note that
	 ...
	 * @param {Vector3} [data.objectData.grabOffset] GrabOffset
