...
class ParcelSelectObjects extends Packet {
	...
	public static format: Collection<string, any> = new Collection([
		...
		[
			"returnIDs",
			{ parameters: new Collection<string, any>([["return", Types.UUID]]) },
		],
	])

	/**
	 * ParcelSelectObjects constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link ParcelSelectObjects.format}. Note that
