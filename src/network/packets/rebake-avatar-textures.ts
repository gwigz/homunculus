...
class RebakeAvatarTextures extends Packet {
	...
	public static format: Collection<string, any> = new Collection([
		...
		[
			...
			{
				quantity: 1,
				parameters: new Collection<string, any>([["texture", Types.UUID]]),
			},
		],
	])

	/**
	 * RebakeAvatarTextures constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link RebakeAvatarTextures.format}. Note that
