...
class ScriptSensorReply extends Packet {
	...
	public static format: Collection<string, any> = new Collection([
		...
		[
			...
			{
				quantity: 1,
				parameters: new Collection<string, any>([["source", Types.UUID]]),
			},
		],
		// tslint:disable-next-line:max-line-length
		[
	...
	/**
	 * ScriptSensorReply constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link ScriptSensorReply.format}. Note that
