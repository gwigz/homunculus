 ...
 */
class SetStartLocationRequest extends Packet {
	/**
	...
	/**
	 * SetStartLocationRequest constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link SetStartLocationRequest.format}. Note that
	 ...
	 * @param {Variable1} [data.startLocationData.simName] SimName
...
export default SetStartLocationRequest
