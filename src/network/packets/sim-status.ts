...
class SimStatus extends Packet {
		...
		[
			"simStatus",
			{
				...
				parameters: new Map<string, any>([
					["canAcceptAgents", Types.Boolean],
					["canAcceptTasks", Types.Boolean],
				]),
			},
		],
	])
	...
	/**
	 * SimStatus constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link SimStatus.format}. Note that
