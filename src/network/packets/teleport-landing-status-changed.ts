...
class TeleportLandingStatusChanged extends Packet {
	...
	/**
	 * TeleportLandingStatusChanged constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link TeleportLandingStatusChanged.format}. Note that
