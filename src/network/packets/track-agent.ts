...
class TrackAgent extends Packet {
	...
	public static format: Collection<string, any> = new Collection([
		...
		[
			...
			{
				quantity: 1,
				parameters: new Collection<string, any>([["prey", Types.UUID]]),
			},
		],
	])

	/**
	 * TrackAgent constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link TrackAgent.format}. Note that
