...
class TransferInventoryAck extends Packet {
	...
	/**
	 * TransferInventoryAck constructor, can be passed either a fully
	 * initialized Packet Buffer or an object containing this Objects required
	 * parameters from {@link TransferInventoryAck.format}. Note that
